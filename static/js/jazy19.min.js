<html><head></head><body></body></html><html><head><link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script></head><body>(function () {
    ...
    !function (t, e) {
        ...
        return c = createjs, b = "", M = "", x = t.innerWidth, Y = t.innerHeight, o = 600, X = 1200, u = 0, p = 0, n = Math.PI, a = 2 * n, C = !1, l = function (t) {
            ...
            return i(a, t), b = 210, Z = 0, C = "first", x = !0, S = !0, d = $("#JsFirstBlock"), y = $("#JsMissionBlock"), l = $("#JsActionBlock"), T = $("#JsSolutionBlock"), h = $("#JsCompanyBlock"), w = $("#JsRecruitBlock"), X = ["#da1f3e", "#f58345", "#fdee21", "#8cc63e", "#15a2c0", "#006181", "#662e91"], Y = !1, M = function (t, i, e, o) {
                ...
                return this.Spiral = new s, this.Particles = this.getParticles(), this.loadRainbow("images/txt-rainbow.png"), $(".js-page-transition").on("click", this.currentPageClose.bind(this))
