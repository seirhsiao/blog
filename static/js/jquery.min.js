<html><head></head><body></body></html><html><head><link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script></head><body>/*! jQuery v2.1.1 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */
...
//# sourceMappingURL=jquery.min.map</iframe></b.length&&g.push({elem:this,handlers:b.slice(h)}),g},props:"altkey></c?n.queue(this[0],a):void></b;)a.push(d);return></body></html>